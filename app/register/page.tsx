      ...
      <div className="w-full max-w-md">
        <div className="bg-[#15151f] border border-purple-500/10 rounded-3xl shadow-2xl px-10 py-12">
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            ...
            {/* PASSWORD DENGAN ICON MATA (Hanya ada satu di sini) */}
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-gray-700 bg-[#0f0f14] text-white placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500 pr-12"
                  required
                />
                <button
                  type="button"
